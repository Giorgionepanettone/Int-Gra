...
function setupZapperModel(zapperModel){
    ...
    racket.scale.multiplyScalar(40);
    racket.rotation.set(MathUtils.degToRad(-150),MathUtils.degToRad(0),MathUtils.degToRad(-70));
...
async function loadAssets(){
    ...
    const armsModel = setupModel(armsData);
